/* This is where the image is going to appear  TEST :D test 2 :_) test 3 :(*/
...
const db = {
        ...
        },
	{
	    ...
	    parts : [
		[ //scales
		    [187, 24, 36], [233, 78, 72], [153, 24, 29], [118, 24, 21], [180, 18, 29]
		],
		[ //belly
		    [254, 231, 192], [209, 163, 118], [129, 95, 75], [205, 163, 118], [252, 231, 193]
		],
		[ //weapons
		    [125, 125, 125], [181, 181, 181], [82, 82, 82], [58, 52, 59], [105, 106, 106], /*ball*/ [86, 92, 118], [115, 121, 149], [62, 64, 98], [78, 69, 80]
		],
		[ //horns
		    [102, 93, 106], [80, 72, 82], [57, 51, 58]
		],
		[ //clothes
		    [89, 65, 64], [65, 47, 47]
		]
	...
	},
	{
	    ...
	    parts : [
		[ //body
		    [36, 117, 121], [7, 87, 87], [10, 61, 61]
		],
		[ //hands
		    [44, 72, 116], [28, 53, 92]
		],
		[ //scarf
		    [230, 218, 25], [179, 157, 26]
		],
		[ //belly
		    [187, 231, 200], [124, 162, 152]
		],
		[ //beak
		    [89, 82, 83], [61, 56, 57]
		]
	...
	},
        {
            ...
            parts : [
                ...
                [ //ice
                    [127, 239, 103], [82, 186, 71], [36, 125, 46]
                ],
                [ //shading
                    [67, 68, 87], [50, 51, 62], [39, 39, 48]
                ]
            ],
            placeholder : "0000-0000-0000-0000-0000"
        },
        {
            ...
            parts : [
                ...
                [ //suit
                    [69, 69, 89], [50, 51, 62], [149, 52, 3], [39, 39, 48], [30, 30, 36]
                ],
                [ //bandages
                    [193, 193, 157], [156, 141, 110], [255, 255, 228]
                ],
